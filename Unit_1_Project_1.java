        ...
        try { // I used the try and catch because it's a great way to eliminate any errors that come up, such as entering something that isn't a number
            ...
            if (choiceInt == 1) { // Fahrenheit to Celsius conversion
                try {
                    ...
                    double fahrenheit = myObj.nextDouble(); // Reads user input again in double format
                    double cConversion = ((double) 5 / 9) * (fahrenheit - 32); // Casting to get an exact value of Celsius
                ...
                try {
                    ...
                    double fConversion = ((celsius * ((double) 9 / 5)) + 32);
